...
const char *keyTranslation[][2] = {
    ...
    { "----:com.apple.iTunes:SEASON_TOTAL", "SEASONTOTAL" },
    { "----:com.apple.iTunes:EPISODE_TOTAL", "EPISODETOTAL" },
    { "----:com.apple.iTunes:COPYRIGHT_URL", "COPYRIGHTURL" },
